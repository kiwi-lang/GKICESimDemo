...
#include "GKICESimDemoWheelFront.h"
#include "GKICESimDemoWheelRear.h"
...
const FName AGKICESimDemoPawn::LookUpBinding("LookUp");
const FName AGKICESimDemoPawn::LookRightBinding("LookRight");
const FName AGKICESimDemoPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

AGKICESimDemoPawn::AGKICESimDemoPawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = UGKICESimDemoWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = UGKICESimDemoWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = UGKICESimDemoWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = UGKICESimDemoWheelRear::StaticClass();
...
void AGKICESimDemoPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AGKICESimDemoPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AGKICESimDemoPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AGKICESimDemoPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AGKICESimDemoPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AGKICESimDemoPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AGKICESimDemoPawn::OnResetVR); 
}

void AGKICESimDemoPawn::MoveForward(float Val)
{
	if (Val >= 0)
	{
...
void AGKICESimDemoPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AGKICESimDemoPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AGKICESimDemoPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AGKICESimDemoPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AGKICESimDemoPawn::EnableIncarView(const bool bState)
{
...
void AGKICESimDemoPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AGKICESimDemoPawn::BeginPlay()
{
	Super::BeginPlay();
...
void AGKICESimDemoPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AGKICESimDemoPawn::UpdateHUDStrings()
{
...
void AGKICESimDemoPawn::SetupInCarHUD()
{
...
void AGKICESimDemoPawn::UpdatePhysicsMaterial()
{
